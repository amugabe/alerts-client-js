...
module.exports = (() => {
	...
	class AlertManager extends Disposable {
		constructor(host, port, secure, mode) {
			...
			if (mode === 'rest') {
				adapter = new RestAlertAdapter(host, port, secure, onAlertMutated.bind(this), onAlertDeleted.bind(this));
			} else {
				adapter = new SocketAlertAdapter(host, port, secure, onAlertMutated.bind(this), onAlertDeleted.bind(this));
			}
