...
module.exports = (() => {
	...
	class RestAlertAdapter extends AlertAdapterBase {
		constructor(host, port, secure, onAlertMutated, onAlertDeleted) {
			...
			let secureToUse = connection.getIsSecure(secure);
			...
			this._restProvider = new RestProvider(host || 'alerts-management-prod.barchart.com', portToUse, secureToUse);
